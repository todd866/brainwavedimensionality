...
For a normalised eigenmode $\psi$ across $N$ oscillators:
\begin{equation}
...
\begin{itemize}
    ...
    \item \textbf{Beta oscillations ($k \approx 3$)}: Intermediate compression. The manifold is constrained but remains ``floppy''---continuous enough for analog manipulation, mental rotation, holding ambiguity.
