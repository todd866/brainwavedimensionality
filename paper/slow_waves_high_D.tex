...
We propose that the frequency spectrum implements a \emph{dimensional hierarchy}---a cascade of information bottlenecks characterised by spatial participation (how many oscillators engage coherently), not latent state-space dimensionality:
...
This offers a geometric interpretation of why we can \emph{think about} paradoxes (beta, meta-cognition) but cannot \emph{decide} them (gamma, assertion). Under this view, the dimensional constraint determines what kinds of logic are representable.
...
The author thanks the Fulcher Lab, University of Sydney, for feedback on an early version of this work.
