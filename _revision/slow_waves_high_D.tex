...
\centering
\small
\caption{Working hypothesis: frequency bands as dimensional regimes. $N_{\text{eff}}$ (participation ratio) describes how many oscillators engage coherently; $k$ (interface rank) describes the effective dimensionality of a downstream readout. Delta/theta primarily provides substrate; interface rank $k$ applies when downstream circuits read out.}
\label{tab:hierarchy}
\begin{tabular}{@{}lcccc@{}}
\toprule
\textbf{Band} & \textbf{Participation} & \textbf{Interface} & \textbf{Topology} & \textbf{Function} \\
\midrule
Delta/Theta & High $N_{\text{eff}}$ & (substrate) & Volumetric & Analog substrate \\
Beta & Moderate & $k \approx 3$ & Compliant manifold & Meta-cognition \\
Gamma & Low $N_{\text{eff}}$ & $k \approx 2$ & Discrete clusters & Symbols, decisions \\
\bottomrule
\end{tabular}
\end{table}
...
The participation ratio (PR), originally developed to quantify localisation in disordered solids \citep{bell1970atomic} and widely applied in neural population analysis \citep{gao2017theory}, measures how many oscillators contribute significantly to a given mode. For a normalised eigenmode $\psi$ across $N$ oscillators:
\begin{equation}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{figures/fig3_real_connectome_pr.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{figures/fig4_code_formation_bottleneck.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{figures/fig5_paradox_topology.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/fig6_stress_collapse.pdf}
...
\centering
\small
\caption{Interface types with qualitatively different computational properties.}
\label{tab:interfaces}
\begin{tabular}{@{}lcll@{}}
\toprule
\textbf{Type} & \textbf{Rank} & \textbf{Function} & \textbf{Example} \\
\midrule
Affective & $k \approx 1$--3 & Mode selection & Fear, arousal \\
Categorical & $k = 2$ & Discrete symbols & Decisions, labels \\
Compliant & $k \geq 3$ & Analog manipulation & Reasoning \\
\bottomrule
\end{tabular}
\end{table}
